                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent" style="float: right;">
                        <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <li><a class="dropdown-item" href="user_profile.php">Account</a></li>
                                    <li><a class="dropdown-item" href="seller_product.php">Shop</a></li>
                                    <li><a class="dropdown-item" href="customer_home.php">Logout</a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="container py-5">
                <div class="row d-flex justify-content-center my-4">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="row">
                            ...
                            <div class="bg-image hover-overlay hover-zoom ripple rounded" data-mdb-ripple-color="light">
                                <img src="https://images.wisegeek.com/carpenter.jpg"
                            ...
                            <p>Rate per Hour:   <strong>₱ 17.99</strong></p>
                            ...
                            <div class="d-flex mb-4" style="max-width: 300px">
                                ...
                                <div class="form-outline">
                                    <input id="form1" min="0" name="quantity" value="1" type="number" class="form-control text-start text-md-center" />
                                </div>
                        ...
                        <div class="row">
                            ...
                            <!-- Image -->
                            <div class="bg-image hover-overlay hover-zoom ripple rounded" data-mdb-ripple-color="light">
                                <img src="https://alis.alberta.ca/media/697347/electrician-istock-487018428.jpg"
                                class="w-100" />
                                <a href="#!">
                                <div class="mask" style="background-color: rgba(251, 251, 251, 0.2)"></div>
                                </a>
                    ...
                    <div class="card mb-4 mb-lg-0">
                        ...
                        <img class="me-2" width="150px" height="80px"
                            src="https://sugbo.ph/wp-content/uploads/2020/05/globe-gcash.png"
                            alt="Gcash" />
                        <img class="me-2" width="150px" height="60px"
                            src="https://raw.githubusercontent.com/aizpop/AvengerSquad_HardwareNi/main/images/PCash.PNG"
                        ...
                        <div class="card mb-4">
                            <div class="card-header py-3">
                                ...
                                <button type="button" class="btn btn-primary btn-lg btn-block">
                                    <a href="cart.php" style="text-decoration: none; color: #fff">Go to checkout</a>
                                </button>
                            </div>
                        </div>
                    </div>
