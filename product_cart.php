                    ...
                    <div class="card mb-4">
                        ...
                        <div class="row">
                            ...
                            <div class="bg-image hover-overlay hover-zoom ripple rounded" data-mdb-ripple-color="light">
                                <img src="https://ae01.alicdn.com/kf/HTB1CneYKVXXXXczXpXXq6xXFXXXz/Heavy-saving-40-Diagonal-pliers-diagonal-pliers-diagonal-cutting-pliers-Household.jpg"
                                class="w-100" alt="Diagonal Pliers" />
                                <a href="#!">
                        ...
                        <div class="row">
                            ...
                            <!-- Image -->
                            <div class="bg-image hover-overlay hover-zoom ripple rounded" data-mdb-ripple-color="light">
                                <img src="https://cf.shopee.ph/file/d398f8849f21e519c2741e2a362c5ad4"
                                class="w-100" />
                                <a href="#!">
                                <div class="mask" style="background-color: rgba(251, 251, 251, 0.2)"></div>
                                </a>
                            ...
                            <div class="col-lg-5 col-md-6 mb-4 mb-lg-0">
                            <!-- Data -->
                            <p><strong>Bicycle Set kit</strong></p>
                            <p>Color: Black</p>
                            <p>Size: None</p>
                            <p>Price: <strong>₱ 17.99</strong></p>
                            <button type="button" class="btn btn-primary btn-sm me-1 mb-2" data-mdb-toggle="tooltip"
