  ...
  <body>
    ...
    <div class="sidebar">
      ...
      <ul class="nav-links">
        ...
        <li>
          <a href="dashboard_order_product.php">
            <i class='bx bx-grid-alt'></i>
          ...
          <div class="container-fluid">
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                  <a href="dashboard_order_service.php" class="nav-link active" style="padding-left: 50px;padding-right: 50px;">
                      ...
                      <tr>
                        <td style="width: 100px;">
                          ...
                          <form action="add_products.php" method="POST" enctype="multipart/form-data">
                            ...
                            <button type="submit" class="btn btn-warning" name="submit" id="submitBtn">Add Product</button>
                            <button class="btn btn-secondary">
                              <a href="seller_product.php" style="color:white">Cancel</a>
                            </button>
                          </form>
                        </td>
                      </tr>
